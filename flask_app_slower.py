...
def ExploreLocationStart():
    ...
    #Get all locations
    AllLocations = df_result.iloc[:][0].unique()

    global global_database
    global_database=df_result
